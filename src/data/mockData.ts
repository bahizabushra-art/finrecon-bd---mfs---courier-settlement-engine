...
export const INITIAL_RETURN_PARCELS: ReturnParcelRecord[] = [
  ...
  },
  {
    ...
    courierReportedStatus: 'RETURNED',
    deltaDaysInTransit: 12, // 12 days > 7-10 day SLA threshold
    vector1OverchargeVarianceBDT: 5.00,
    vector1Status: 'LOGISTICS_RETURN_VARIANCE_ERROR',
    vector2RetentionGap: true,
    vector2AlertMessage: 'Delta: 12 Days > 7-Day Hub Retention SLA (Potential Lost/Stolen Inventory Asset)',
    vector3GhostException: false,
    notes: 'VECTOR 2 RETENTION GAP: Parcel marked RETURNED by Steadfast 12 days ago but never reached merchant gate.'
  },
  {
    id: 'ret-a-03',
    traceId: 'TR-RET-203',
