            ...
            <div className={`p-4 rounded-xl border ${
              ...
              <div className="flex items-center justify-between">
                ...
                <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                  ...
                  {isV1Breach ? 'LOGISTICS_RETURN_VARIANCE_ERROR' : 'VALID'}
                </span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 mt-3 pt-3 border-t border-slate-800/80">
                ...
                <div>
                  ...
                  <span className={`font-bold ${isV1Breach ? 'text-rose-400' : 'text-emerald-400'}`}>
                    {isV1Breach ? `+ ${formatBDT(overchargeVariance)}` : 'BDT 0.00'}
                  </span>
                </div>
              </div>
            </div>
